...
def getInfoFile():
	path = "/home/pi/static/rplace/"
	files_png = path + "png/"
	choice = random.choice(os.listdir(files_png))
	if os.path.exists(path + "image.info"):
		os.remove(path + "image.info")
	os.system("file " + "/home/pi/static/rplace/png/" + choice + " > /home/pi/static/rplace/image.info")

#set the size of the image from the file to a variable
def getSize():
	with open("/home/pi/static/rplace/image.info", "r") as f:
		lines = f.read()
		listed = lines.split(",")
		pixels = listed[1]
...
def cropImages(ran_l, ran_w, ran_dir):
	...
	l = ran_l
	w = ran_w
	image = Image.open("/home/pi/static/rplace/png/rplace.png")
	...
	while count < 10:
		...
		count += 1
		image.save("/home/pi/static/rplace/jpg/" + filename, "PNG")
		#Move
		if ran_dir == "North":
			l = l - 5
		elif ran_dir == "East":
...
def delImages():
	files_jpg = "/home/pi/static/rplace/jpg/"
...
def displayImage():
	playingImage = "sudo /home/pi/display32x64/rpi-rgb-led-matrix/utils/led-image-viewer -t0.5 --led-cols=64 /home/pi/static/rplace/jpg/*.png"
	try:
